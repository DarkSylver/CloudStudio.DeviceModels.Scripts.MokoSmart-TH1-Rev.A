...
# Parsing + Configuration Script – MokoSmart-TH1 - Rev. A

This **Parsing + Configuration** script is designed for the **MokoSmart-TH1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MokoSmart-TH1 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **MokoSmart-TH1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
